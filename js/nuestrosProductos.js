...
const containerProducts = document.getElementById('nuestprod-carrusel-content');
containerProducts.innerHTML = cards;

// CARRUSEL NUESTROS PRODUCTOS

const carruselContentNP = document.getElementById('nuestprod-carrusel-content');
